        ...
        <?php else: ?>
            ...
            <div class="bg-white px-6 py-3 border-b border-gray-300 shadow-sm flex items-center justify-between z-20">
                <div class="flex items-center gap-4">
                    <a href="messagerie.php" class="md:hidden p-2 -ml-2 text-gray-600 hover:bg-gray-100 rounded-full transition">
...
async function loadConversations() {
    try {
        ...
        convs.forEach(c => {
            ...
            div.href = `messagerie.php?conv_id=${c.conversation_id}`;
