...
<div class="min-h-screen bg-gray-50 py-10 font-sans">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="admin_requests.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 border border-gray-200">
            ...
            <a href="admin_camp_requests.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 border border-gray-200">
                <div class="flex items-center justify-between">
            ...
            <a href="admin_demande_virement.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 border border-gray-200">
                <div class="flex items-center justify-between">
            ...
            <div class="lg:col-span-3">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <a href="admin_history_accepted.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 border border-gray-200">
                    ...
                    <a href="admin_history_refused.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition duration-300 border border-gray-200">
