...
try {
    ...
    if (!$data) {
        ...
        die('<div class="container mx-auto py-20 text-center"><h1 class="text-3xl font-bold text-red-600">Accès Refusé</h1><p class="mt-4 text-gray-600">Inscription introuvable ou vous n\'avez pas les droits.</p><a href="reservations.php" class="inline-block mt-6 bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700 transition">Retour aux réservations</a></div>');
    }
    ...
    <div class="relative w-full h-72 lg:h-96 bg-gray-900 shadow-xl overflow-hidden group">
        ...
        <div class="absolute bottom-0 left-0 w-full p-4 sm:p-8">
            <div class="container mx-auto max-w-6xl">
                <a href="reservations.php" class="inline-flex items-center text-gray-300 hover:text-white mb-4 transition text-sm font-medium">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sm:p-8 relative">
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <a href="modif_child.php?id=<?= $data['enfant_real_id'] ?>" class="text-sm bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-1.5 rounded-lg transition flex items-center">
            ...
            <div class="lg:col-span-1 space-y-8">
                ...
                <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-6 text-center">
                    ...
                    <div class="space-y-3">
                        <a href="messagerie.php?new_conv=<?= $data['orga_user_id'] ?>&camp_id=<?= $camp_id ?>" class="block w-full py-2.5 px-4 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-xl transition shadow-lg shadow-blue-500/30 flex items-center justify-center">
