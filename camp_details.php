...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    try {
        ...
        if(camp.inscription_en_ligne == 1 && places > 0) {
            ctaHtml = `
                <a href="inscription.php?t=${camp.token}" class="flex items-center justify-center gap-2 w-full bg-[#0A112F] hover:bg-opacity-90 text-white font-bold py-4 px-6 rounded-xl shadow-lg transform transition hover:scale-[1.02] text-center text-lg">
